...
public class MovieSimilarity {
	...
	public static void main(String[] args) throws IOException {
		...
		for(File file : inputFiles) {
			...
			String outFilePath = outputDirPath + "\\SimilarityMatrix_" + file.getName();
			...
			//printConvertedMatrixForEachGenre(outFilePath, ratingsMapByMovieId, movieIdsMap);
	...
	public static void findSimilarities(Map<Integer, Map<Integer, Float>> ratingsMapByMovieId, String outFilePath,
			Map<Integer, Integer> movieIdsMap) throws IOException {
	...
	public static void printConvertedMatrixForEachGenre(String outFilePath, Map<Integer, Map<Integer, Float>> ratingsMapByMovieId, Map<Integer, Integer> movieIdsMap) throws IOException {
