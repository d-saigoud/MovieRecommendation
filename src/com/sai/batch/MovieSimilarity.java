...
public class MovieSimilarity {
	...
	public static void main(String[] args) throws IOException {
		...
		/*String inFilePath = "C:\\Users\\sai goud\\Documents\\Masters\\Courses\\Data Mining\\ml-20m\\ConvertedMatrix.csv";
		
		String outFilePath = "C:\\Users\\sai goud\\Documents\\Masters\\Courses\\Data Mining\\ml-20m\\SimilarityMatrix.csv";
		...
		*/
		...
		Map<Integer, Map<Integer, Float>> ratingsMapByMovieId = getRatingsMapByMovieAsKey("C:/Users/sai goud/Documents/Masters/Courses/Data Mining/ml-20m/ratings.csv");
	...
	public static void findSimilarities(String inFilePath, String outFilePath, Set<Integer> movieIdsSet) throws IOException {
	...
	public static void findSimilarities(Map<Integer, Map<Integer, Float>> ratingsMapByMovieId, String outFilePath, Map<Integer, Integer> movieIdsMap) throws IOException {
		...
		for(int movie1 : movieIdsMap.keySet()) {
			...
			for(int movie2 : movieIdsMap.keySet()) {
				...
				line += ","; 
				//System.out.println("movieIdsMap.get(i) : " + movieIdsMap.get(i));
				...
				if(ratingsMapByMovieId.get(movie1) != null && ratingsMapByMovieId.get(movie2) != null) {
					List<List<Float>> listOfMovieVectors = prepareMovieVectors(ratingsMapByMovieId, movie1, movie2);
				...
				//System.out.println(ratingsMapByMovieId.get(i) + " : " + ratingsMapByMovieId.get(j));
	...
	public static float getSimilarity(List<List<Float>> listOfMovieVectors) {
		...
		return listVectorForMovieIndex1.size() > 1 ? (float) Math.round((numerator * 100 / Math.sqrt(denominator1 * denominator2)))/ 100 : 0;
		
	}
	
	public static List<List<Float>> prepareMovieVectors(String filePath, int movieIndex1, int movieIndex2) throws IOException {
	...
	public static List<List<Float>> prepareMovieVectors(Map<Integer, Map<Integer, Float>> ratingsMapByMovieId, int i,
		...
		for(int userId : ratingsMapByMovieId.get(i).keySet()) {
			...
			if(ratingsMapByMovieId.get(j).containsKey(userId)) {
